...
function Features() {
  const items = [
    { n: "01", accent: "var(--rose)", deep: "var(--rose-deep)", icon: "/answers/0.webp", lead: "速いほど、", key: "高得点" },
    { n: "02", accent: "var(--sky)", deep: "var(--sky-deep)", icon: "/answers/1.webp", lead: "リアルタイムで、", key: "繋がる" },
    { n: "03", accent: "var(--amber)", deep: "var(--amber-deep)", icon: "/answers/2.webp", lead: "アカウント、", key: "不要" },
    { n: "04", accent: "var(--sage)", deep: "var(--sage-deep)", icon: "/answers/3.webp", lead: "作るのも、", key: "かんたん" },
  ];
  return (
